...
export default function AuthPage() {
	...
	const [sedangMengirimKeServer, setSedangMengirimKeServer] =
	...
	const ApakahSemuaInputTerisi = (): boolean => {
		if (!isLogin) {
			...
			return (
				["username", "email", "password"] as (keyof typeof formData)[]
			...
			<div className='w-full max-w-md bg-white rounded-lg shadow-lg border border-gray-200'>
				...
				<div className='p-6'>
					...
					<form
						...
						className='space-y-4'>
						<div
							className={!isLogin ? "grid md:grid-cols-2 gap-4" : "space-y-4"}>
						...
						{isLogin && (
							<div className='flex justify-between'>
								...
								<Link
									...
									className='text-sm text-[#41218b] hover:underline'>
									Forgot password?
								</Link>
							</div>
						)}
						...
						<Button
							type='submit'
							className='w-full bg-[#41218b] hover:bg-[#331a6e]'>
				...
				<div className='flex justify-center border-t border-gray-200 py-4'>
					<Link
						href='/'
						className='text-[#41218b] text-center font-semibold'>
						Back to home
					</Link>
				</div>
			</div>
